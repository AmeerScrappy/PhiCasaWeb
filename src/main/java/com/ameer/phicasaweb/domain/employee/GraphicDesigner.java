 ...
 */
@Entity
public class GraphicDesigner implements Serializable, Employee {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GraphicDesigner)) {
            return false;
        }
        GraphicDesigner other = (GraphicDesigner) object;
    ...
    public String toString() {
        return "com.ameer.phicasaweb.domain.employee.GraphicDesigner[ id=" + id + " ]";
    }
