 ...
 */
@Entity
public class CreativeDirector implements Serializable, Employee {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CreativeDirector)) {
            return false;
        }
        CreativeDirector other = (CreativeDirector) object;
    ...
    public String toString() {
        return "com.ameer.phicasaweb.domain.employee.CreativeDirector[ id=" + id + " ]";
    }
