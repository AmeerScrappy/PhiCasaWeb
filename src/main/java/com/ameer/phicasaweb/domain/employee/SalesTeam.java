 ...
 */
@Entity
public class SalesTeam implements Serializable, Employee {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SalesTeam)) {
            return false;
        }
        SalesTeam other = (SalesTeam) object;
    ...
    public String toString() {
        return "com.ameer.phicasaweb.domain.employee.SalesTeam[ id=" + id + " ]";
    }
