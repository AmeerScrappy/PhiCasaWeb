 ...
 * @author Scrappy
 */
public class TotalCreativeDirectorServiceTest {
    
    public TotalCreativeDirectorServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalCreativeDirectorService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalCreativeDirectorService.class);
//         List<CreativeDirector> entities = service.getTotal();
//         
