 ...
 * @author Scrappy
 */
public class TotalGraderServiceTest {
    
    public TotalGraderServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalGraderService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalGraderService.class);
         List<Grader> entities = service.getTotal();
