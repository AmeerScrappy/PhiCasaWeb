 ...
 * @author Scrappy
 */
public class TotalDistributionTeamServiceTest {
    
    public TotalDistributionTeamServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalDistributionTeamService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalDistributionTeamService.class);
         List<DistributionTeam> entities = service.getTotal();
