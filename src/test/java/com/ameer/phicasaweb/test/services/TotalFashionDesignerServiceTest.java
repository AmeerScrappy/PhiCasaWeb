 ...
 * @author Scrappy
 */
public class TotalFashionDesignerServiceTest {
    
    public TotalFashionDesignerServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalFashionDesignerService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalFashionDesignerService.class);
//         List<FashionDesigner> entities = service.getTotal();
//         
