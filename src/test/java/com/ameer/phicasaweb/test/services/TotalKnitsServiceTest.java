 ...
 * @author Scrappy
 */
public class TotalKnitsServiceTest {
    
    public TotalKnitsServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalKnitsService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalKnitsService.class);
//         List<Knits> entities = service.getTotal();
//         
