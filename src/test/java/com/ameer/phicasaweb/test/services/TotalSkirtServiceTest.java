 ...
 * @author Scrappy
 */
public class TotalSkirtServiceTest {
    
    public TotalSkirtServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalSkirtService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalSkirtService.class);
         List<Skirt> entities = service.getTotal();
