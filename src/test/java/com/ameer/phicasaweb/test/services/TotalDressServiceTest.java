 ...
 * @author Scrappy
 */
public class TotalDressServiceTest {
    
    public TotalDressServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalDressService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalDressService.class);
//         List<Dress> entities = service.getTotal();
//         
