 ...
 * @author Scrappy
 */
public class TotalPantsServiceTest {
    
    public TotalPantsServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalPantsService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalPantsService.class);
//         List<Pants> entities = service.getTotal();
//         
