 ...
 * @author Scrappy
 */
public class TotalPatternMakerServiceTest {
    
    public TotalPatternMakerServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalPatternMakerService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalPatternMakerService.class);
//         List<PatternMaker> entities = service.getTotal();
//         
