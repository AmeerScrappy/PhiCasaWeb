 ...
 * @author Scrappy
 */
public class TotalJacketServiceTest {
    
    public TotalJacketServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalJacketService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalJacketService.class);
//         List<Jacket> entities = service.getTotal();
//         
