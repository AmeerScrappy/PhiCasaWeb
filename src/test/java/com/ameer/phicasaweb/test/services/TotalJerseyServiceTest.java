 ...
 * @author Scrappy
 */
public class TotalJerseyServiceTest {
    
    public TotalJerseyServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalJerseyService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalJerseyService.class);
//         List<Jersey> entities = service.getTotal();
//         
