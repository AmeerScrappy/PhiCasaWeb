 ...
 * @author Scrappy
 */
public class TotalVIPCustomerServiceTest {
    
    public TotalVIPCustomerServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalVIPCustomerService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalVIPCustomerService.class);
//         List<VIPCustomer> entities = service.getTotal();
//         
