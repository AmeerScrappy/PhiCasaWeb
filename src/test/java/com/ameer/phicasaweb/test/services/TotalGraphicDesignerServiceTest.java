 ...
 * @author Scrappy
 */
public class TotalGraphicDesignerServiceTest {
    
    public TotalGraphicDesignerServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalGraphicDesignerService service;
   
   
    @Test
     public void total() {
//         service = ctx.getBean(TotalGraphicDesignerService.class);
//         List<GraphicDesigner> entities = service.getTotal();
//         
