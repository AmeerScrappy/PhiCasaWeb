 ...
 * @author Scrappy
 */
public class TotalRegularCustomerServiceTest {
    
    public TotalRegularCustomerServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalRegularCustomerService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalRegularCustomerService.class);
         List<RegularCustomer> entities = service.getTotal();
